...
export const settingsApi = {
  ...
  webhookLogs: (p?: { limit?: number; status?: string }) => api.get('/settings/webhook-logs', { params: p }),
...
export const superadminApi = {
  ...
  deleteFailedJob: (uuid: string) => api.delete(`/superadmin/failed-jobs/${uuid}`),
  flushFailedJobs: () => api.delete('/superadmin/failed-jobs'),
  ...
  clearErrorLogs: (source: string) => api.delete('/superadmin/errors', { params: { source } }),
  ...
  clearSystemLog: (file: string) => api.delete('/superadmin/system-log', { params: { file } }),
...
export const planApi = {
  ...
  previewChange: (planId: number, durationType: string) => api.post('/plans/preview-change', { plan_id: planId, duration_type: durationType }),
