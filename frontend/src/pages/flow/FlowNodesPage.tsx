        ...
        <>
          <div
            className={`border-2 border-dashed rounded-lg p-3 text-center cursor-pointer transition-colors ${
              block.url && block.asset_id ? 'border-green-400 bg-green-50' :
      ...
      <div className={`border border-gray-200 rounded-xl mb-1.5 overflow-hidden ${!dn.include ? 'opacity-40' : ''}`}>
        ...
        <div className="flex items-center gap-2 px-3 py-2 bg-gray-50 border-b border-gray-100">
          ...
          <span className={`text-xs font-semibold px-1.5 py-0.5 rounded-full flex-shrink-0 ${
            dn.original.type === 'list'   ? 'bg-blue-50 text-blue-600' :
        ...
        >
          <div className="flex items-center gap-2 px-3 py-2.5">
            ...
            <span
              ...
              className={`text-gray-300 text-sm select-none flex-shrink-0 ${
                dragEnabled ? 'cursor-grab active:cursor-grabbing' : 'cursor-not-allowed opacity-30'
              }`}>⠿</span>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {loading ? (
          ...
          >
            ...
            {dragEnabled && (
              <div
                className={`h-10 rounded-xl border-2 border-dashed mt-3 flex items-center justify-center text-xs transition-all ${
                  dragOver === 'root'
                ...
                <div className="relative">
                  <input
                    className={`form-control font-mono text-sm ${
                      replyStatus === 'taken' ? 'border-red-400' :
