...
class HrSetting extends Model
{
    ...
    protected $fillable = [
        ...
        'overtime_multiplier', 'late_penalty_amount', 'payroll_working_days', 'deduct_unpaid_leave', 'deduct_absent_days', 'auto_availability', 'leave_auto_approve', 'reopen_auto_approve', 'timezone',
