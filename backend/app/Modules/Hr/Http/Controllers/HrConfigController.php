...
class HrConfigController extends Controller
{
    ...
    public function updateSettings(Request $request): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'clock_out_early_window_minutes' => 'nullable|integer|min:0|max:120',
            'clock_out_grace_minutes'        => 'nullable|integer|min:0|max:120',
            ...
            'late_clockin_notify_user_ids'   => 'nullable|array',
            'late_clockin_notify_user_ids.*' => 'integer',
            'late_clockout_notify_user_ids'  => 'nullable|array',
            'late_clockout_notify_user_ids.*' => 'integer',
            'break_overrun_notify_user_ids'  => 'nullable|array',
            'break_overrun_notify_user_ids.*' => 'integer',
            'leave_request_notify_user_ids'  => 'nullable|array',
            'leave_request_notify_user_ids.*' => 'integer',
        ]);
